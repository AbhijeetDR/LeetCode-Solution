  ...
  public:
    ...
    vector<int> maximumValue(Node* node) {
        ...
        while(!q.empty()){
            ...
            while(q.empty() == 0 && q.front().second == front.second){
                pair<Node*, int> front1 = q.front();
                maxNode = max(maxNode, front1.first->data);
                if(front1.first->left != nullptr)q.push({front1.first->left, front1.second+1});
                if(front1.first->right != nullptr)q.push({front1.first->right, front1.second+1});
                q.pop();
            }
